  ...
  return (
    <div className="base-container">
      ...
      <div className="stats">
        ...
        <div className="stat-entry">
          {"Calories Spent: " + healthData.caloriesSpent + "kcal"}
        </div>
      </div>
      ...
      <Dialog open={open} onClose={handleClose}>
        ...
        <DialogContent>
          <TextField
            ...
            variant="standard"
            defaultValue={
              healthData.weight /* this might spawn a bug when switching between entries */
            }
            error={weightError}
          ...
          <TextField
            ...
            onChange={(event: React.ChangeEvent<HTMLInputElement>) => {
              const err =
                +event.target.value < 0 || +event.target.value > 10000;
              setCaloriesError(err);

              if (!err) {
                const updatedHD = {
                  ...healthData,
                  caloriesSpent: +event.target.value,
                };
                updateHealthData(updatedHD);
                setHealthData(updatedHD);
              }
